...
function createMap(magnitude, timer, year, month, day) {
	...
	var projection = __WEBPACK_IMPORTED_MODULE_0_d3__["geoMercator"]()
	...
	var svg = __WEBPACK_IMPORTED_MODULE_0_d3__["select"](document.body).append("svg").attr("width", width).attr("height", height);
...
//https://s3-us-west-2.amazonaws.com/s.cdpn.io/25240/world-110m.json
			...
			var xAxis = svg.append('g')
															  ...
															  .call(__WEBPACK_IMPORTED_MODULE_0_d3__["axisTop"](x));
			...
			__WEBPACK_IMPORTED_MODULE_0_d3__["json"](`https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=${startDateString}&endtime=${currentDateString}&minmagnitude=${magnitude}`, function(error, data) {
					if(error) throw error;
...
function createNewMap(magnitude, timer, year, month, day) {
	var chart = __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"]('svg');
	chart.remove();
